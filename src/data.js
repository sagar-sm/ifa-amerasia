export const DATA = [
    ...
    },
    {
       ...
       keywords:  'Thomas More, Vespucci, America, Utopia, New World, Ringmann, Waldseemüller, Thevet, Foucault, heterotopia',
    },
    {
        id: 'weitzman-armeria',
        x: 0.364,
        ...
        keywords: 'Ferdinando I de’ Medici, Uffizi, Buti, Mason, Markey, Keating, Asia, America, Brazil, Rhinoceros, Weiditz, Boone, Stradano, Vespucci, Sahagún, Lazzaro, Burgkmair, Hogenberg, Braun, Mason, Guardaroba, Ortelius, Danti',
    },
    {
        ...
        keywords: 'Tangut, Cathay, Mangi, Marco Polo, Rosselli, Finé, Waldseemüller, Behaim, Zaiton, Gastaldi, Anian, Ortelius, Ruysch, Ramusio, Mexico, Gruzinski, O’Gorman',
    },
    {
        id: 'chang-paradise',
        x: 0.984,
        ...
        title: 'Paradise',
        keywords: 'paradise, Mandeville, D’Ailly, Columbus, Hereford map, Augustine, Paria, Milton, Brendan, Ptolemy, Adam, Eve, Scafi, Flint',
    },
    {
        ...
        keywords:  'Prester John, Ethiopia, Africa, India, Marco Polo, Abyssinia, Mandeville, Dati, Schedel, Juan de la Cosa, Waldseemüller, Ringmann, Alvares, Olives, Ortelius, Orla, Larmessin, D’Almeida',
    },
    {
        id: 'strauss-magi',
        x: 0.850,
        ...
        keywords: 'Tharsis, Balthasar, Melchior, Caspar, Magi, Fernandes, Cabral, Koerner, Prester John, Vespucci, Marco Polo, Inca, Tupinamba, Dürer, Holanda, Mason, Russo, Maino, Moctezuma,'
    },
    {
        id: 'riccio-india',
        x: 0.177,
        ...
        keywords:  'India, Indiano, Marco Polo, Danti, Guardaroba, Sarto, Ariosto, Tasso, Vasari, ALdrovandi, Benavides, Dürer, Altdorfer, Burgkmair',
    },

    {
        ...
        keywords: 'Cospi, hieroglyphic, Mixtec, China, writing, Legato, Mendoza, Thevet, Alciato, Valeriano, Dolendo, Mander, Kircher, Hakluyt',
    }
